...
class Linkedin:
    ...
    def __init__(self):
        ...
        self.base_url = ['https://www.linkedin.com/jobs/search?keywords=Backend%20Development&location=India&locationId=&geoId=102713980&sortBy=R&f_TPR=r86400&f_JT=F&f_E=1%2C2&position=1&pageNum=0',
    ...
    def extract_job_info(self, linkedin_jobs_per_page, ids_present):    
        
        
        for job in linkedin_jobs_per_page:
            

            try:
                print(1)
                time.sleep(3)
                id_val = job.find_element_by_class_name("base-search-card--link")
            ...
            try:
                print(3)
                job_company = job.find_element_by_class_name("base-search-card__subtitle")
